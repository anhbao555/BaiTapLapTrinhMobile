...
if (markHigherBMI > 0) {
    console.log("Mark has a higher BMI than John in Data 1 \n")
}
else console.log("Mark doesn't have a higher BMI than John in Data 1 \n")
...
markHigherBMI = Markbmi - Johnbmi
if (markHigherBMI > 0) {
    console.log("Mark has a higher BMI than John in Data 2 \n")
}
else console.log("Mark doesn't have a higher BMI than John in Data 2 \n")